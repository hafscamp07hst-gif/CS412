...
# Description: Configure the CS412 Django project.
"""
...
SECRET_KEY = 'django-insecure-h&ml&!&@1w!ry37p8!^uwn95z^t-@ij)sf-i@zsq*ubbg8fnow'
...
if socket.gethostname() == "cs-webapps.bu.edu":
    STATIC_URL = "/sthwang/static/"
